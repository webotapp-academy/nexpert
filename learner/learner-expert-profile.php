                            ...
                            <div class="absolute -bottom-3 left-1/2 -translate-x-1/2 lg:left-auto lg:right-0 lg:translate-x-0 flex flex-col gap-2 items-center">
                                ...
                                <div id="trust-tier-badge" class="hidden">
                                    <span class="inline-flex items-center gap-2 bg-indigo-600 text-white text-xs font-black px-4 py-1.5 rounded-full shadow-lg ring-2 ring-gray-800 uppercase tracking-wider">
                                        ...
                                        <span id="trust-tier-label">Tier C</span>
                                    </span>
                                </div>
                            </div>
                        </div>
...
<!-- Footer -->
<footer class="bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 text-white mt-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div class="lg:col-span-1">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h3 class="text-2xl font-black text-white">Nexpert.ai</h3>
                </div>
                <p class="text-gray-400 leading-relaxed mb-6">
                    Connect with world-class experts and accelerate your learning journey with personalized guidance.
                </p>
                <div class="flex gap-4">
                    ...
                    <a href="#" class="w-10 h-10 bg-gray-800 hover:bg-blue-700 rounded-full flex items-center justify-center transition-colors">
            ...
            <!-- For Learners -->
            <div>
                <h4 class="font-bold text-lg mb-6 text-white">For Learners</h4>
                <ul class="space-y-3">
                    <li><a href="?panel=learner&page=browse-experts" class="text-gray-400 hover:text-white transition-colors">Browse Experts</a></li>
                    <li><a href="?panel=learner&page=my-programs" class="text-gray-400 hover:text-white transition-colors">My Programs</a></li>
                    <li><a href="?panel=learner&page=dashboard" class="text-gray-400 hover:text-white transition-colors">Dashboard</a></li>
                    <li><a href="?panel=learner&page=messages" class="text-gray-400 hover:text-white transition-colors">Messages</a></li>
                </ul>
            </div>

            <!-- For Experts -->
            <div>
                <h4 class="font-bold text-lg mb-6 text-white">For Experts</h4>
                <ul class="space-y-3">
                    <li><a href="?panel=expert&page=auth" class="text-gray-400 hover:text-white transition-colors">Become an Expert</a></li>
                    <li><a href="?panel=expert&page=dashboard" class="text-gray-400 hover:text-white transition-colors">Expert Dashboard</a></li>
                    <li><a href="?panel=expert&page=earnings" class="text-gray-400 hover:text-white transition-colors">Earnings</a></li>
                    <li><a href="?panel=expert&page=my-programs" class="text-gray-400 hover:text-white transition-colors">My Programs</a></li>
                </ul>
            </div>
        ...
        <div class="pt-8 border-t border-gray-800">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-gray-400 text-sm">
                    © 2025 Nexpert.ai. All rights reserved.
                </p>
