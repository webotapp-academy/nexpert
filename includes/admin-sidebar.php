...
<div class="fixed left-0 top-0 h-full w-64 bg-gray-900 text-white flex flex-col z-50">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <a href="?panel=admin&page=credibility" 
           class="flex items-center px-4 py-3 rounded-lg transition <?php echo $currentPage === 'credibility' ? 'bg-primary text-white' : 'text-gray-300 hover:bg-gray-800'; ?>">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
