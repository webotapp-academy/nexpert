...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 pb-6 border-b border-gray-800">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="index.php?panel=expert&page=daily-credibility-card" class="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-4 py-2.5 rounded-xl font-bold text-xs hover:from-purple-500 hover:to-indigo-500 transition shadow-lg flex items-center gap-1.5">
                <span>✨</span><span>Daily Credibility Card</span>
            </a>
