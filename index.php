...
$learner_pages = ['auth', 'profile', 'browse-experts', 'expert-profile', 'booking', 'payments', 'dashboard', 'notifications'];
$expert_pages = ['auth', 'profile-setup', 'workflow-builder', 'booking-management', 'session-execution', 'earnings', 'learner-management', 'notifications'];
...
if ($page === 'home') {
    ...
    $file_path = "learner/learner-{$page}.html";
    ...
    $file_path = "expert/expert-{$page}.html";
    if (file_exists($file_path)) {
        include $file_path;
    } else {
        render_404();
